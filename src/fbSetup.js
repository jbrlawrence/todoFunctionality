...
// exporting the objects created in the initialization of the authentication and firestore services
// the exported objects can be imported in main code (see index.js)
